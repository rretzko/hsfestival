                    ...
                    <div class="flex flex-col mb-2">
                        <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                                ...
                                <form method="POST" action="{{ route('eventmanagement.adjudicators.store') }}" >
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="flex flex-row">
                                            <input class="mr-2" type="text" name="first" id="first" value="" placeholder="First name"/>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="flex flex-row">
                                            <input class="" type="text" name="title" id="title" value="" placeholder="Dr., Mr., Ms., etc..."/>
                                        </div>
                                        <div>
                                            @error('title')
                                            <span class="bg-white text-red-500 px-2 text-sm ">{{ $message }}</span>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="flex flex-row">
                                            <input class="" type="text" name="from" id="from" value="" placeholder="University, Organization, etc..."/>
                                        </div>
                                        <div>
                                            @error('from')
                                            <span class="bg-white text-red-500 px-2 text-sm ">{{ $message }}</span>
