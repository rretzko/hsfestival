            ...
            <div id="page content" class="bg-indigo-500 w-full h-full ml-6 py-10 px-4 text-xl">
                ...
                <section class="border mb-1 px-2 rounded">
                    ...
                    <header class="uppercase">
                        <a href="{{ route('eventmanagement.passwordreset.index') }}">
                            Password Reset
                        </a>
                    </header>
                    ...
                    <div class="flex flex-col mb-2">
                        <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                                ...
                                <form method="POST" action="{{ route('eventmanagement.passwordreset.update') }}" >
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="password" type="password" value="Password1!"/>
                                        @error('password')
                                        <span class="bg-white text-red-500 px-2 text-sm">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="password-confirmation" type="password" value="Password1!"/>
