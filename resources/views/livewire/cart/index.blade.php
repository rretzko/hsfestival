                ...
                <thead>
                    <tr>
                        ...
                        <th>
                            ...
                            @include('components.table.sort', ['field' => 'inventory.name'])
                        </th>
                        <th>
                        </th>
                    </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex justify-end">
                                    ...
                                    @endcan
                                    @can('cart_delete')
                                        <button class="btn btn-sm btn-rose mr-2" type="button" wire:click="confirm('delete', {{ $cart->id }})" wire:loading.attr="disabled">
                                            {{ trans('global.delete') }}
                                        </button>
                                    @endcan
                                </div>
