                    ...
                    <div class="flex flex-col mb-2">
                        <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                                ...
                                <form method="POST" action="{{ route('recordingengineer.update', $adjudication) }}" enctype='multipart/form-data'>
                                        ...
                                        <select name="school_id">
                                            ...
                                            @foreach($schools AS $school)
                                                <option value="{{$school->id }}"
                                                    @if($adjudication->school->id == $school->id) selected @endif
                                                >
                                                    {{$school->name }}
                                                </option>
                                            @endforeach
                                        ...
                                        <select name="ensemble_id">
                                            ...
                                            @foreach($ensembles AS $ensemble)
                                                <option value="{{$ensemble->id }}"
                                                    @if($adjudication->ensemble->id == $ensemble->id) selected @endif
                                                >
                                                    {{$ensemble->name }} ({{ $ensemble->school->name }})
                                                </option>
                                            @endforeach
                                        </select>
                                        @error('ensemble_id')
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="adjudicator_id">
                                            ...
                                            @foreach($adjudicators AS $adjudicator)
                                                <option value="{{$adjudicator->id }}"
                                                    @if($adjudication->adjudicator->id == $adjudicator->id) selected @endif
                                                >
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="part">
                                            @for($i=1;$i<10;$i++)
                                                <option value="{{$i }}"
                                                    @if($adjudication->part == $i) selected @endif
                                                >
                                                    {{ $i }}
                                                </option>
                                            @endfor
                                    ...
                                    <div class="input-group mt-4">
                                        <label> </label>
                                        <input class="text-blueGray-800 px-2" type="submit" name="submit" value="Update" />
                                    </div>
                                </form>
                            </div>
                        </div>
