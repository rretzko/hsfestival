    ...
    <div class="flex row text-white space-x-2">
        ...
        <div id="page content" class="bg-indigo-500 w-full h-full ml-6 py-10 px-4 text-xl">
            <header class="uppercase mb-4">
                Event Ensembles Repertoire: New for {{ $ensemble->name }}
            </header>
            ...
            <div>
                ...
                <form method="post" action="{{ route('user.repertoire.store', ['event' => $event, 'ensemble' => $ensemble]) }}" class="max-w-6xl">
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            <textarea cols="60 rows=5" id="movements" name="movements"></textarea>
                        </div>
                        @error('movements')
                    ...
                    <x-buttons.submit val="Add Repertoire" />
